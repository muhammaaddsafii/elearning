...
@section('title')
  <title>Assessor Dashboard GSM - Add Modul</title>
@endsection
  ...
  <div class="content-page">
      <div class="content">
          <div class="container">
              <div class="row">
                <div class="col-sm-12">
                  <h4 class="page-title">Evaluasi Tantangan</h4>
                  <ol class="breadcrumb">
                    <li>
                      <a href="{{ url('/') }}">Home</a>
                    </li>
    ...
    $(document).ready(function(){
      ...
      function populateDataTable(data) {
        ...
        for (var i = 0; i < length; i++) {
          ...
          var action = "<a class='btn btn-primary btn-xs waves-effect waves-light' href='tantangan/review?id="+data.data[i]._id+"'> <i class='ti-new-window'></i> Review</a>";
          switch (b) {

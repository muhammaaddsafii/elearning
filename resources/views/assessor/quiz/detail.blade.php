...
@section('title')
  <title>Assessor Dashboard GSM - Detail Aktivitas</title>
@endsection
      ...
      .done(function(data, status){
        ...
        if (data.data.flag == 'scored'){
          ...
          for (var i=0; i<data.data.image.length; i++) {
            $('#image-quiz').append(
              '<img id="preview" src="'+urlImage+'/storage/images/'+data.data.image[i].filename+'" alt="'+data.data.image[i].filename+'" height="300px" width="auto">&nbsp&nbsp&nbsp'
            );
          }

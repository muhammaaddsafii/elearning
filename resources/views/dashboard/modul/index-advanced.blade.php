...
@section('title')
  <title>Admin Dashboard GSM - Modul Advanced</title>
@endsection
  ...
  <div class="content-page">
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h4 class="page-title">List Modul Advanced</h4>
            <ol class="breadcrumb">
              <li>
                <a href="{{ url('/') }}">Home</a>
              </li>
        ...
        <div class="panel">
          <div class="panel-body">
            ...
            <table class="table table-striped table-bordered" id="modulAdvancedTable">
              <thead>
                <tr>
                  <th>Judul</th>
                  <th>Kategori</th>
...
@section('js')
  <script>
    $(document).ready(function(){
      $("#modulAdvancedTable").DataTable();
      $.ajax({
        type: 'GET',
        url: "{{ url('/') }}/api/v1/modul/grade/advanced",
      })
      ...
      function populateDataTable(data) {
        $("#modulAdvancedTable").DataTable().clear();
        ...
        for (var i = 0; i < length; i++) {
          ...
          $('#modulAdvancedTable').dataTable().fnAddData([
            a,
            b,
            fix_c,
            action

  ...
  <div class="content-page">
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h4 class="page-title">Sekolah Jejaring GSM</h4>
            <ol class="breadcrumb">
              <li>
                <a href="{{ url('/') }}">Home</a>
              </li>
        ...
        <div class="panel">
          <div class="panel-body">
            ...
            <table class="table table-striped table-bordered" id="sJejaringTable">
              <thead>
                <tr>
                  <th>NPSN</th>
                  <th>Nama</th>
...
@section('js')
  <script>
    $(document).ready(function(){
      $("#sJejaringTable").DataTable();

      $.ajax({
        type: 'GET',
        url: "{{ url('/') }}/api/v1/sekolah/label/jejaring_gsm",
      })
      ...
      function populateDataTable(data) {
        $("#sJejaringTable").DataTable().clear();
        ...
        for (var i = 0; i < length; i++) {
          ...
          $('#sJejaringTable').dataTable().fnAddData([
            a,
            b,
            c,
            d,
